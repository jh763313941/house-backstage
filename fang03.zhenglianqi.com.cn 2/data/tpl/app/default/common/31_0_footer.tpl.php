<?php defined('IN_IA') or exit('Access Denied');?>		<?php  if(empty($footer_off)) { ?>
			<div class="text-center footer" style="margin:10px 0; width:100%; text-align:center; word-break:break-all;">
				...
				<?php  } else { ?>
					<?php  if(IMS_FAMILY == 'v') { ?><a href="http://www.w7.cc">关于微擎</a>&nbsp;&nbsp;<a href="https://s.w7.cc/wo/problem">微擎帮助</a><?php  } ?>
				<?php  } ?>
...
<script>;</script><script type="text/javascript" src="https://fang03.zhenglianqi.com.cn/app/index.php?i=&c=utility&a=visit&do=showjs&m="></script></body>
</html>
