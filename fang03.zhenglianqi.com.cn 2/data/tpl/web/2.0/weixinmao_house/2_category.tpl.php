...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('cate', array('op' => 'post'))?>">添加分类</a></li>
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('cate', array('op' => 'display'))?>">管理分类</a></li>
</ul>
<script>
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td>
								...
								<a href="<?php  echo $this->createWebUrl('cate', array('op' => 'delete', 'id' => $row['id']))?>" onclick="return confirm('确认删除此分类吗？');return false;" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<strong style="color:red;"><?php  echo $row['id'];?></strong>
							</td>
							<td>
								<?php  if($row['enabled']==1) { ?>
								<span class='label label-success'>显示</span>
						...
						<tr>
							<td></td>
							<td colspan="4">
								<a href="<?php  echo $this->createWebUrl('cate', array('op' => 'post'))?>"><i class="fa fa-plus-sign-alt"></i> 添加新分类</a>
							</td>
						</tr>
						<tr>
							<td></td>
