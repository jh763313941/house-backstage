...
<ul class="nav nav-tabs">
	...
	<a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => -1))?>">全部订单</a>
	</li>
			...
			<form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<input class="form-control" name="member" id="" type="text" value="<?php  echo $_GPC['member'];?>" placeholder="可查询手机号">
					</div>
				</div>
		...
		<div class="panel-body table-responsive">
			<table class="table table-hover">
				...
				<tr>
					...
					<td>
						<?php  if($item['paid'] == 0) { ?>未支付<?php  } else { ?>已支付<?php  } ?>
                    </td>
