...
<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('common/header-vice', TEMPLATE_INCLUDEPATH)) : (include template('common/header-vice', TEMPLATE_INCLUDEPATH));?>
<?php  } else { ?>
