		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
                  ...
                  <td><?php  if($adv['type']==0) { ?><span class='label label-success'>首页幻灯片</span> <?php  } ?><?php  if($adv['type']==1) { ?><span class='label label-success'>首页中间广告1</span> <?php  } ?><?php  if($adv['type']==2) { ?><span class='label label-success'>首页中间广告2</span> <?php  } ?><?php  if($adv['type']==3) { ?><span class='label label-success'>首页中间广告3</span> <?php  } ?></td>
		...
		<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style="color:red">*</span>类型</label>
          <div class="col-sm-8 col-xs-12">
              <select class="form-control tpl-category-parent we7-select" id="type" name="type">
                      <option value="0" <?php  if($adv['type'] == 0) { ?> selected <?php  } ?>>首页幻灯片</option>
                                    
                       <option value="1" <?php  if($adv['type'] == 1) { ?> selected <?php  } ?>>首页中间广告</option>
                  
                        <option value="2" <?php  if($adv['type'] == 2) { ?> selected <?php  } ?>>首页底部广告</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class='radio-inline'>
							<input type='radio' name='toway' value='toNagivate' <?php  if($adv['toway']=='toNagivate') { ?>checked<?php  } ?> /> nagivateto
						</label>
						<label class='radio-inline'>
							<input type='radio' name='toway' value='toSwitchtab' <?php  if($adv['toway']=='toSwitchtab') { ?>checked<?php  } ?> /> switchtab
						</label>
                      <label class='radio-inline'>
							<input type='radio' name='toway' value='toWxapp' <?php  if($adv['toway']=='toWxapp') { ?>checked<?php  } ?> /> 小程序
						</label>
					</div>
				</div>
