...
<ul class="nav nav-tabs">
	...
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shophouse', array('op' => 'display'))?>">门面商铺出售管理</a></li>
	<li <?php  if($operation == 'displaylet') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shophouse', array('op' => 'displaylet'))?>">门面商铺出租管理</a></li>
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shophouse', array('op' => 'post'))?>">添加门面商铺出售</a></li>
  	<li <?php  if($operation == 'postlet') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shophouse', array('op' => 'postlet'))?>">添加门面商铺出租</a></li>
	...
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1" onsubmit='return formcheck()'>
		<div class="panel panel-default">
			<div class="panel-heading">
				<?php  if(empty($item['id'])) { ?>添加门面商铺出售<?php  } else { ?>编辑门面商铺出售<?php  } ?>
			</div>
			<div class="panel-body">
				
				<div class="tab-content">
					<div class="tab-pane  active" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shophouse_basic', TEMPLATE_INCLUDEPATH)) : (include template('shophouse_basic', TEMPLATE_INCLUDEPATH));?></div>
...
<div class="main">
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1" onsubmit='return formcheck()'>
		<div class="panel panel-default">
			<div class="panel-heading">
				<?php  if(empty($item['id'])) { ?>添加门面商铺出租<?php  } else { ?>编辑门面商铺出租<?php  } ?>
			</div>
			<div class="panel-body">
				
				<div class="tab-content">
					<div class="tab-pane  active" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shoplethouse_basic', TEMPLATE_INCLUDEPATH)) : (include template('shoplethouse_basic', TEMPLATE_INCLUDEPATH));?></div>
...
<?php  } else if($operation == 'displaylet') { ?>
