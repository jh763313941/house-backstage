...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('letbusinesshouse', array('op' => 'post'))?>">添加商业出租房</a></li>
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('letbusinesshouse', array('op' => 'display'))?>">管理商业出租房</a></li>
	...
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1" onsubmit='return formcheck()'>
		<div class="panel panel-default">
			<div class="panel-heading">
				<?php  if(empty($item['id'])) { ?>添加商业出租房<?php  } else { ?>编辑商业出租房<?php  } ?>
			</div>
			<div class="panel-body">
				
				<div class="tab-content">
					<div class="tab-pane  active" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('letbusinesshouse_basic', TEMPLATE_INCLUDEPATH)) : (include template('letbusinesshouse_basic', TEMPLATE_INCLUDEPATH));?></div>
