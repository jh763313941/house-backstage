	...
	<div class="panel we7-panel ">
		...
		<div class="panel-body">
			<div class="account-list">
				...
				<div class="account-item" ng-repeat="link_account in link_accounts" ng-if="$index < 4"> <!-- 最多4个-->
					<img ng-src="{{ link_account.logo }}" class="account-img logo" alt="">
					<div class="info">
						<div class="title">
							<span class="text-over name" ng-click="link_account.switchurl ? account_switch(link_account.switchurl) : ''">{{ link_account.name }}</span>

							<a ng-if="link_account.switchurl && link_account.unbindurl" class="action" ng-click="unbind_module(link_account.switchurl, link_account.unbindurl)">去解绑</a>
						</div>
						<div class="type">
