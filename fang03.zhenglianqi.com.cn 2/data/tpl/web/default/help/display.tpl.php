...
<div style="z-index: 1;" class="iframe-div">
	<iframe src="//s.w7.cc/index.php?c=wiki&a=view&id=2&list=29&simple=1<?php  if($_W['isadmin']) { ?>&role=admin<?php  } ?>" marginheight="0" marginwidth="0" frameborder="0" width="100%" height="100%" allowTransparency="true"></iframe>
</div>
<?php  } ?>
<?php  if($do == 'custom') { ?>
<div style="z-index: 1;" class="iframe-div">
