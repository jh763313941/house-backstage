			...
			<div>
				...
				<div class="form-files we7-margin-bottom">
					...
					<div class="form-file">
						...
						<div class="form-value"><?php  echo $settings['policeicp']['policeicp_location'];?> <?php  echo $settings['policeicp']['policeicp_code'];?><span class="we7-margin-left">直接填写联网备案信息即可,点击可跳转至互联网安全管理服务平台</span></div>
						<div class="form-edit">
