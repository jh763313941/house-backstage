...
<div class="media media-wechat-setting">
	...
	<div class="media-body media-middle ">
		<h4 class="media-heading color-dark"><?php  echo $version_info['modules'][0]['title'];?></h4>
		<div class="color-gray">版本: v<?php  echo $version_info['version'];?></div>
	</div>
	<div class="media-right media-middle">
		<a href="./index.php?c=wxapp&a=front-download&do=getpackage&uniacid=<?php  echo $_W['uniacid'];?>&version_id=<?php  echo $version_info['id'];?>"
...
<div class="alert-info">
	<div class="alert alert-warning alert-dismissible" role="alert">
		...
		该小程序应用已更新至最新版本：<?php  echo $module['version'];?>。此小程序当前版本为：<?php  echo $version_info['version'];?>，需要重新上传微信审核最新版本应用。
	</div>
</div>
<?php  } ?>
<div class="panel we7-panel wxapp-examine-self panel-table we7-margin-top" id="codeupload" ng-controller="code_upload_ctrl">
	...
	<div class="panel-heading" ng-show="show_step1">之前小程序版本：<?php  echo $version_info['version'];?></div>
		...
		<form action="" class="we7-form" id="codeform" ng-show="show_step1" ng-init="user_version = '<?php  echo $user_version;?>'; user_desc = '<?php  echo $version_info['description'];?>'">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<button class="btn btn-primary" type="button" id="begin-upload" ng-click="beforeUpload(<?php  echo $version_info['support_live'];?>)">确 认</button>
				</div>
			</div>
		</form>
